...
export const Icons = {
  ...
  PiggyBank: ({ size = 20, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19 5c-1.5 0-2.8 1.4-3 2.8l-1.2-0.4c-2.9-0.9-6.1 0.9-6.8 3.9l-0.7 2.9c-0.2 0.8 0.3 1.6 1.1 1.8l1.9 0.5c0.8 0.2 1.6-0.3 1.8-1.1l0.7-2.9c0.4-1.5 1.9-2.4 3.4-2l1.2 0.4c0.2 1.4 1.5 2.8 3 2.8"/>
